...
describe('at-angular:page named-page', function() {
  ...
  it('should create the expected page files', function(done) {
    const expected = [
      'src/app/pages/named-page/named-page.controller-spec.js',
      'src/app/pages/named-page/named-page.controller.js',
      'src/app/pages/named-page/named-page.html',
      'src/app/pages/named-page/named-page.module.js',
      'src/app/pages/named-page/named-page.route.js',
      'src/app/pages/named-page/named-page.scss'
    ];
    assert.file(expected);
    // calling done
    done();
